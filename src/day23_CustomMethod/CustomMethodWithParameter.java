...
public class CustomMethodWithParameter {
    public static void main(String[] args) {
        ...
        oddOrEven(10);// bir onceki methodta paraentez icinde  birsey yazilmiyordu burada mesela 10 nun evenmi odd mu oldugu soruyorsu run
        // yapinva even yazisi cikiyor
