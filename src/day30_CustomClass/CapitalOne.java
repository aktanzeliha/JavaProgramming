...
public class CapitalOne {
  public static void main(String[] args) {
   ...
   employee5.setInfo("Kevin",'M',35,2298,"Senior QA", 110000,true);
    ...
    int countFullTime = 0;
    int countPartTime = 0;
    double max = employees[0].salary;// burada employee1 in en yiksek salary aldigini
    // farz ediyoruz sonra bundan buyukse onu yaz deyip devam ediyoruz[0] buradaki zero indez number

    double min = employees[0].salary;// emplooyee1 has min salary farzediyoruz
