...
public class ArrayUtility {
    ...
    // print each String  of an Stringf  array in seperate lines
    ...
    // returns the minimum  numbre from integer array
    ...
    // returns the minimum number from double
...
// check if the given integer is contained in the given array. returns boolean
    ...
    public static boolean contains(double[] array, double element) {
        boolean result = false;
        for (double each : array) {
            if (each == element) {// if any array's element is mayching with the given element , it means the given elements is coontained the given element
                result = true;
            }
        }
